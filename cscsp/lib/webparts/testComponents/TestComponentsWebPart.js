...
export default class TestComponentsWebPart extends BaseClientSideWebPart {
    constructor() {
        super(...arguments);
        this._isDarkTheme = false;
    }
    render() {
        const element = React.createElement(TestComponents, {
...
//# sourceMappingURL=TestComponentsWebPart.js.map